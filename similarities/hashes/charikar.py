from similarities.hashes.functions import string_hash_bit
...
class CharikarHash(hashtype):
    ...
    def _string_hash(self, v):
        """
        Modified by CB.  Original one didn't support larger bitspaces (>92).
        """
        return string_hash_bit(v,self.hashbits)
